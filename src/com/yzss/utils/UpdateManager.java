...
public class UpdateManager {
	...
	public void checkAppUpdate(Context context, final boolean isShowMsg) {
		...
		HttpUtil.get(url, new JsonHttpResponseHandler() {
			...
			public void onSuccess(JSONObject arg0) {
				...
				final Update update = JSON.parseObject(arg0.toString(),
						Update.class);
				msg.what = 1;
				msg.obj = update;
	...
	private Runnable mdownApkRunnable = new Runnable() {
		...
		public void run() {
			try {
				String apkName = "HuaShiApp_" + mUpdate.getVersionName()
						+ ".apk";
				String tmpApk = "HuaShiApp_" + mUpdate.getVersionName()
						+ ".tmp";
				// 判断是否挂载了SD卡
