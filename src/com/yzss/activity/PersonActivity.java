...
import com.yzss.dialog.AlterPassWordDialog;
...
import com.yzss.utils.ImageUtils;
...
public class PersonActivity extends BaseActivity {
	...
	private void init() {
		...
		nickLayout.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				// TODO Auto-generated method stub
				AlterNickDialog alterPersonDialog = new AlterNickDialog(
						PersonActivity.this);
				alterPersonDialog.show();
			}
		});
	...
	private void setValue() {
		...
		ImageLoader.getInstance().displayImage(myself.getFace(),
				circleImageView);
		Utils.setUser(PersonActivity.this, JSON.toJSONString(myself));
	}

	@Override
	protected void onResume() {
		// TODO Auto-generated method stub
		myself = Utils.getUser(PersonActivity.this);	
		setValue();
		super.onResume();
	}
	...
	class AlterNickDialog extends Dialog {
		...
		private void getAlterNick() {
			if (Utils.isNetWorkConnected(context)) {
				String url = UrlConfig.getAlterPerson(myself.getId(),
						dialog_alter_person_et.getText().toString(),
						myself.getSex());
				HttpUtil.get(url, new JsonHttpResponseHandler() {
					...
					public void onSuccess(JSONObject arg0) {
						...
						if (Utils.requestOk(arg0)) {
							myself = JSON.parseObject(Utils.getResult(arg0),
									BnUser.class);
