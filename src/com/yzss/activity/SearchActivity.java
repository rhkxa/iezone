...
import com.yzss.adapter.KeyListViewAdapter;
...
public class SearchActivity extends BaseActivity {
	...
	private void init() {
		...
		if (Utils.getKeyWords(SearchActivity.this) != null) {
			keylist.clear();
			keylist.addAll(JSON.parseArray(
					Utils.getKeyWords(SearchActivity.this), String.class));
		}
		...
		key_single.setData(Utils.setSingleMap(keylist));
		...
		layout_search_bar_button.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View arg0) {
				...
				keylist.add(key);
				Utils.setKeyWords(SearchActivity.this,
						JSON.toJSONString(keylist));
