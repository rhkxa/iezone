...
public class OrderChildListViewAdapter extends BaseAdapter {
	private Context context;
	private List<BnShopping> data;

	public OrderChildListViewAdapter(Context context, List<BnShopping> data) {
	...
	public View getView(final int arg0, View arg1, ViewGroup arg2) {
		...
		if (arg1 == null) {
			...
			arg1 = LayoutInflater.from(context).inflate(
					R.layout.item_order_child_list, null);
		...
		vh.item_goods_number.setText("数量：" + data.get(arg0).getQuantity());
